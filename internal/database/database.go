...
func Open(ctx context.Context, url string) (*Database, error) {
	...
	if err = d.Ping(ctx); err != nil { pool.Close(); return nil, err }
	return d, nil
}
...
func (d *Database) QueryRow(ctx context.Context, q string, args ...any) pgx.Row { return d.pool.QueryRow(ctx, q, args...) }
func (d *Database) Exec(ctx context.Context, q string, args ...any) (pgconn.CommandTag, error) { return d.pool.Exec(ctx, q, args...) }
